...
_OP_NAME_MAP = {
    ...
    "aten::gather": OpType.GATHER,
    "aten::index_select": OpType.GATHER,
    "aten::transpose": OpType.TRANSPOSE,
    "aten::reshape": OpType.RESHAPE,
    "aten::view": OpType.RESHAPE,
    # Rotary positional embedding (custom op names)
    "rope": OpType.ROPE,
    "rotary_embedding": OpType.ROPE,
    # ONNX ops
    "onnx::Gemm": OpType.MATMUL,
    "onnx::MatMul": OpType.MATMUL,
    "onnx::Conv": OpType.CONV2D,
    "onnx::Relu": OpType.RELU,
    "onnx::Add": OpType.ADD,
    "onnx::Sub": OpType.ADD,
    "onnx::LayerNormalization": OpType.LAYER_NORM,
    "onnx::Softmax": OpType.SOFTMAX,
    "onnx::Gelu": OpType.GELU,
    "onnx::Mul": OpType.MUL,
    "onnx::Gather": OpType.GATHER,
    "onnx::Transpose": OpType.TRANSPOSE,
    "onnx::Reshape": OpType.RESHAPE,
    "onnx::Flatten": OpType.RESHAPE,
    # Collective communication ops
    "all_reduce": OpType.ALL_REDUCE,
    "c10d::allreduce_": OpType.ALL_REDUCE,
    "all_to_all": OpType.ALL_TO_ALL,
    "c10d::alltoall_": OpType.ALL_TO_ALL,
}
